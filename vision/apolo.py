...
class Apolo:
    ...
    def updateCamConfigs(self, newBrightness, newSaturation, newGain, newContrast, newHue,
        ...
        # adicionar cv2.CAP_PROP_APERTURE, cv2.CAP_PROP_AUTO_EXPOSURE, cv2.CAP_PROP_BACKLIGHT, cv2.CAP_PROP_AUTOFOCUS, cv2.CAP_PROP_GAMMA
